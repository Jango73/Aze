...
const int CConstants::s_iError_CouldNotWriteStage           = 12;
const int CConstants::s_iError_NoBranchNameGiven            = 13;
const int CConstants::s_iError_NoFileNameGiven              = 14;
const int CConstants::s_iError_NotARepository               = 15;
const int CConstants::s_iError_UnknownCommand               = 16;
const int CConstants::s_iError_UnknownSwitch                = 17;
