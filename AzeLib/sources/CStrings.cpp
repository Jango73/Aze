...
const QString CStrings::s_sParamCommitParentList                = "commitParentList";
const QString CStrings::s_sParamCommitTreeList                  = "commitTreeList";
...
const QString CStrings::s_sTextCouldNotRemoveFile               = tr("Could not remove file %1.");
